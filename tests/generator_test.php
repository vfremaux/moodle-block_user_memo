 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_user_memo_generator_testcase extends advanced_testcase {
    ...
    public function test_generator() {
        ...
        $generator = $this->getDataGenerator()->get_plugin_generator('block_user_memo');
        $this->assertInstanceOf('block_user_memo_generator', $generator);
        $this->assertEquals('user_memo', $generator->get_blockname());
